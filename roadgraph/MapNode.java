...
class MapNode implements Comparable<MapNode>
{
	...
	double getPriorityFunction(){
		return this.priorityFunction;
	}
	
	void setPriorityFunction(double distance){
		this.priorityFunction = distance;
	}
	
	double getDistanceFromGoal(MapNode goal){
	...
	public int compareTo(MapNode o) {
		...
		if (this.priorityFunction > o.getPriorityFunction()){
			return 1;
		} 
		if (this.priorityFunction < o.getPriorityFunction()){
			return -1;
